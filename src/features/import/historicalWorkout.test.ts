...
describe("historical sheet",()=>{
  it("turns dated columns into completed workout previews and groups repeated exercise rows",()=>{
    const rows=[[],[],[],["Excercise","This Week - Weight*Reps+Lengthened Partials","August 10th","August 3rd","Target Reps","Notes"],["Bench","245*2+1","245*2+1","240*2+1","3",""] ,["Bench","225*5","225*5","225*4+1","8","Form improvements"],["Pushups","0*10","0*11","0*10","AMRAP",""]];
