  ...
  return (
    <div className="sticky top-0 z-50 border-b border-zinc-800 bg-black/95 px-3 py-2 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-3">
        <a href={dashboardHref} className="flex min-w-0 items-center gap-2 rounded-md" aria-label={`Return to ${currentMode} dashboard`}>
          <img src="/branding/PHATbot%20ICON.png" alt="" className="h-8 w-8 shrink-0 object-contain" />
          <p className="min-w-0 whitespace-nowrap text-sm font-bold uppercase tracking-[.16em] text-white sm:text-base">PHATBOT</p>
        </a>
        {dualRole && <div className="flex shrink-0 rounded-lg border border-zinc-700 p-1 text-xs font-bold">
