...
export default function CoachAuthPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (mode === "signup" && !result.data.session) { setMessage("Coach account created. Confirm your email, then return here and sign in. Your pending athlete invitations will be waiting for you."); return; }
