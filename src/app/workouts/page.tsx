...
type Workout = { id: string; name: string; description: string | null; created_at: string };
...
export default function WorkoutsPage() {
  ...
  const loadWorkouts = useCallback(async () => {
    ...
    const { data, error } = await supabase.from("workouts").select("id, name, description, created_at").eq("athlete_user_id", user.id).eq("is_active", true).order("created_at", { ascending: true });
