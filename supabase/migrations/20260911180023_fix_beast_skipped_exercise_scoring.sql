-- Beast V3 eligibility correction:
-- compare only exercises with eligible current work and a prior volume baseline.
-- Finalized periods remain immutable; this migration only replaces scoring functions.
