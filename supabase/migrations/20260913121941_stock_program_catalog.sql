...
insert into _stock_catalog_canonical_exercises values
  ...
  ('Hip Abductor Machine','Glutes','Machine','glutes','isolation','machine','isolation','bilateral','seated'),
  ('Hip Adductor Machine','Other','Machine','other','isolation','machine','isolation','bilateral','seated'),
