...
select * from (values
  ...
  ('Conventional Deadlift','Back','Barbell',true,null::uuid,true,false,'back'::public.exercise_muscle_group,'hinge'::public.exercise_movement_pattern,'barbell'::public.exercise_equipment_category,'compound'::public.exercise_classification,'bilateral'::public.exercise_laterality,'standing'::public.exercise_setup),
...
with secondary(canonical_name, muscle_group, position) as (values
  ...
  ('Conventional Deadlift','glutes'::public.exercise_muscle_group,1),
  ('Conventional Deadlift','hamstrings'::public.exercise_muscle_group,2),
